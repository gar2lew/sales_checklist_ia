...
- Saving Your Appointment (section 18)
...
- "Offline mode" replaced with "Working without an internet connection"
- "Generate Appointment Package" replaced with "Create Final Documents"
...
- Contents page with internal links
- One-Page Quick Reference added
- Final Appointment Checklist added
- In-Person vs Zoom comparison table

### New Screenshots Required
- Connection status indicators
- New Appointment choices dialog
- Complete Handover and Clear Draft button
- Save confirmation with expiry date
