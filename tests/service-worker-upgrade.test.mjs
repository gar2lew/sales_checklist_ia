...
assert.match(source, /const CACHE_VERSION = 'v2.7.0-alpha.32';/, "waiver signing timestamps must advance from v2.7.0-alpha.31 to v2.7.0-alpha.32");
...
assert.equal(openedCaches[0], "sales-capture-v2.7.0-alpha.32", "fresh install must populate the new cache");
