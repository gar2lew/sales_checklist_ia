...
assert.match(source, /const CACHE_VERSION = 'v2\.7\.0-alpha\.10';/, "RC runtime polish must advance from v2.7.0-alpha.9 to v2.7.0-alpha.10");
...
assert.equal(openedCaches[0], "sales-capture-v2.7.0-alpha.10", "fresh install must populate the new cache");
