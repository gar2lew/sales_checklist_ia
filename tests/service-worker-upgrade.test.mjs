...
assert.match(source, /const CACHE_VERSION = 'v2\.7\.0-alpha\.13';/, "prepared email runtime must advance from v2.7.0-alpha.12 to v2.7.0-alpha.13");
...
assert.equal(openedCaches[0], "sales-capture-v2.7.0-alpha.13", "fresh install must populate the new cache");
