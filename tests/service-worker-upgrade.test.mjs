...
assert.match(source, /const CACHE_VERSION = 'v2\.7\.0-alpha\.21';/, "date and package-download hotfix must advance from v2.7.0-alpha.20 to v2.7.0-alpha.21");
...
const context = {
  ...
  caches: {
    ...
    async keys() { return ["sales-capture-v2.7.0-alpha.1", "sales-capture-v2.7.0-alpha.2", "sales-capture-v2.7.0-alpha.3", "sales-capture-v2.6.0", "sales-capture-v2.7.0-alpha.4", "sales-capture-v2.7.0-alpha.5", "sales-capture-v2.7.0-alpha.6", "sales-capture-v2.7.0-alpha.7", "sales-capture-v2.7.0-alpha.8", "sales-capture-v2.7.0-alpha.13", "sales-capture-v2.7.0-alpha.14", "sales-capture-v2.7.0-alpha.15", "sales-capture-v2.7.0-alpha.16", "sales-capture-v2.7.0-alpha.17", "sales-capture-v2.7.0-alpha.18", "sales-capture-v2.7.0-alpha.19", "sales-capture-v2.7.0-alpha.20", "unrelated-cache"]; },
...
assert.equal(openedCaches[0], "sales-capture-v2.7.0-alpha.21", "fresh install must populate the new cache");
...
await lifecyclePromise;
assert.deepEqual(deletedCaches, ["sales-capture-v2.7.0-alpha.1", "sales-capture-v2.7.0-alpha.2", "sales-capture-v2.7.0-alpha.3", "sales-capture-v2.6.0", "sales-capture-v2.7.0-alpha.4", "sales-capture-v2.7.0-alpha.5", "sales-capture-v2.7.0-alpha.6", "sales-capture-v2.7.0-alpha.7", "sales-capture-v2.7.0-alpha.8", "sales-capture-v2.7.0-alpha.13", "sales-capture-v2.7.0-alpha.14", "sales-capture-v2.7.0-alpha.15", "sales-capture-v2.7.0-alpha.16", "sales-capture-v2.7.0-alpha.17", "sales-capture-v2.7.0-alpha.18", "sales-capture-v2.7.0-alpha.19", "sales-capture-v2.7.0-alpha.20"], "upgrade must delete previous application caches without touching unrelated caches");
