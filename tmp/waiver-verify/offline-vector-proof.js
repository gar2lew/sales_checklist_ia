 ...
 * 1. Install SW v2.7.0-alpha.31 (caches pdf-lib + source PDF).
...
try {
  ...
  await page.waitForFunction(async () => {
    ...
    return keys.some((k) => k.includes('sales-capture-v2.7.0-alpha.31'));
  }, null, { timeout: 20000 });
  ...
  console.log('PASS offline vector waiver generation: 6 pages, draft absent, John Smith + date on page 6, vector only');
